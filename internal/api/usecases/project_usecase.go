...
type ProjectUsecase struct {
	rp repository.ProjectRepository
	mr pkgrepository.MetricsRepository
}
...
func (pu *ProjectUsecase) CreateProject(name string) (*model.Project, error) {
	p, err := pu.rp.Save(name, uuid.New().String())
	if err != nil {
