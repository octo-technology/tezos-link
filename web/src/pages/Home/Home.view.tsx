...
export const Home = () => (
  <HomeStyled>
    ...
    <HomeBuilt>
      <HomeSection>
        <HomeH1>Devellop now with our Tezos APIs</HomeH1>
        <HomeH3>
        ...
        <HomeBuiltArg>
          <div>
            ...
            <HomeBuiltArgText>
              Connect your app immediately with our instant access APIs. We support JSON-RPC over HTTPS interfaces,
              providing hight speed connections to the Tezos network.
            </HomeBuiltArgText>
          </div>
